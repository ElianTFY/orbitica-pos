...
- **Secretos y Certificados:** Certificados criptográficos `.p12` de Hacienda Costa Rica nunca se versionan en Git y se cifran con Fernet (AES-128-CBC + HMAC-SHA256).
