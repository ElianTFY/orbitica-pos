      ...
      <div className="space-y-6">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-xs text-[#8E929E]">Administración de locales comerciales y cajas asociadas</p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <Card className="border-l-4 border-l-[#0EA5FF] space-y-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                <Store className="w-5 h-5 text-[#0EA5FF]" />
                <h3 className="text-base font-bold text-white">Sucursal Central (001)</h3>
              </div>
              <Badge variant="success">Principal</Badge>
            </div>
            <div className="space-y-2 text-xs text-[#8E929E]">
              <p className="flex items-center gap-1.5 text-[#CFCFD4]">
                <MapPin className="w-3.5 h-3.5 text-[#0EA5FF]" />
                San José Centro, Avenida Central
              </p>
              <div className="pt-2 border-t border-[#26282E] flex justify-between">
          ...
          <Card className="space-y-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                <Store className="w-5 h-5 text-[#8E929E]" />
            ...
            <div className="space-y-2 text-xs text-[#8E929E]">
              <p className="flex items-center gap-1.5 text-[#CFCFD4]">
                <MapPin className="w-3.5 h-3.5 text-[#8E929E]" />
