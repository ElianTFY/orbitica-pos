      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between p-6 bg-gradient-to-r from-[#141518] to-purple-950/20 border border-purple-500/20 rounded-2xl">
          <div className="space-y-1">
            ...
            <p className="text-xs text-[#8E929E]">Gestión centralizada de organizaciones SaaS, métricas y estado del sistema.</p>
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <Card className="border-l-4 border-l-purple-500">
            <div className="flex items-center justify-between">
              <span className="text-xs text-[#8E929E] font-medium uppercase">Empresas Activas</span>
              <Building2 className="w-4 h-4 text-purple-400" />
            </div>
            <div className="mt-3">
              <span className="text-2xl font-bold text-white">2 / 3</span>
              <span className="text-[11px] text-[#8E929E] block">Tenants registrados</span>
            </div>
          </Card>

          <Card className="border-l-4 border-l-[#0EA5FF]">
            <div className="flex items-center justify-between">
              <span className="text-xs text-[#8E929E] font-medium uppercase">Sucursales Operativas</span>
              <MapPin className="w-4 h-4 text-[#0EA5FF]" />
            </div>
            <div className="mt-3">
              <span className="text-2xl font-bold text-white">4</span>
              <span className="text-[11px] text-[#8E929E] block">Puntos de venta en red</span>
            </div>
          </Card>

          <Card className="border-l-4 border-l-emerald-500">
            <div className="flex items-center justify-between">
              <span className="text-xs text-[#8E929E] font-medium uppercase">Salud del API</span>
              <Activity className="w-4 h-4 text-emerald-400" />
            </div>
            <div className="mt-3">
              <span className="text-2xl font-bold text-emerald-400">99.98%</span>
              <span className="text-[11px] text-[#8E929E] block">Latencia media: 42ms</span>
            </div>
          </Card>
        </div>
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-left text-xs">
              ...
              <tbody className="divide-y divide-[#26282E]">
                {tenants.map((t) => (
                  <tr key={t.id} className="hover:bg-[#1A1B1F]/50 transition-colors">
                    <td className="py-3 font-semibold text-white">{t.trade_name}</td>
                    <td className="py-3 text-[#CFCFD4]">{t.legal_name}</td>
                    <td className="py-3 font-mono text-[#8E929E]">{t.identification_number}</td>
                    <td className="py-3 text-[#CFCFD4]">{t.email}</td>
